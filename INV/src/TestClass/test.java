...
public class test {
	...
	public static void main(String[] args) {
		...
		InventoryItem one = new InventoryItem("Lemon", "Fruit", 0.69, 0.99, 100);
		InventoryItem two = new InventoryItem("Harpoon", "Fishing Gear", 17.99, 26.99, 20);
		InventoryItem three = new InventoryItem("Trenchcoat", "Outerwear", 34.74, 69.99, 15);
		InventoryItem four = new InventoryItem("Apricot", "Fruit", 0.49, 0.99, 300);
